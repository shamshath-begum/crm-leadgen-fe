...
function SignUp() {
    ...
    let handleSignup=async()=>{
      try {
       let res=await axios.post(`${url}/users/signup`,{firstName,lastName,email,password,role,status})
       console.log(res)
       if(res.status===201)
       {
  ...
  <Card className='shadow col-lg-6 mx-auto mt-5'>
    ...
    <h5 style={{textAlign:"center"}}><NavLink to='/users/login-user'><b>Login</b></NavLink></h5>
    </Card>
  </div>
  </>
}
